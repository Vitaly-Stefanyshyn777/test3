  ...
  const renderProductCardSkeleton = () => (
    <div className={productCardStyles.productCard}>
      <div className={productCardStyles.cardImage}>
        ...
        <div className={productCardStyles.badges} style={{ position: 'absolute', top: '12px', left: '12px', gap: '6px' }}>
          <Skeleton width={70} height={36} borderRadius={10} />
        </div>
        <Skeleton circle width={48} height={48} className={productCardStyles.favoriteBtn} style={{ position: 'absolute', top: '25px', right: '25px' }} />
      </div>
      <div className={productCardStyles.cardContent}>
        <Skeleton width="90%" height={24} style={{ marginBottom: "16px" }} className={productCardStyles.productName} />
        <div className={productCardStyles.subscriptionBlock}>
          <div className={productCardStyles.subscriptionPrice}>
            <div className={productCardStyles.pricing}>
              ...
              <Skeleton width={80} height={20} style={{ marginTop: "4px" }} />
            </div>
          </div>
          <Skeleton width={48} height={48} borderRadius={12} className={productCardStyles.cartBtn} />
        </div>
      </div>
    </div>
  );
