...
const items = [
  {
    ...
    text: "Ви подаєте заявку, а команда BFB надає деталі та супровід щодо інструкторства",
  ...
  },
  {
    ...
    text: "Після виконання завдань ви отримуєте сертифікат з номером, що підтверджує право викладати за методикою BFB",
    icon: <СharterIcon />,
    number: "03",
  },
  {
    title: "Доступ до системи",
    text: "Вас додають до каталогу, чату та відкривається доступ до інвентарю, воркшопів і підтримки",
    icon: <LockIcon />,
    number: "04",
  },
];
